...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12" >
          <form method="POST" action="<?php echo base_url().'/crear' ?>">
            <label for="conceptos_Gasto">Concepto de gasto:</label>
            <input type="text" name="conceptos_Gasto" id="conceptos_Gasto" class="form-control">
      ...
      <hr>
      <h2>Listado de Gastos diarios</h2>
            ...
            <table class="table table-hover table-bordered">
              ...
              <?php foreach($datos as $key): ?>
                <tr>
                  ...
                  <td><?php echo $key->conceptos_Gasto ?></td>
